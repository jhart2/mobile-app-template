...
export const PackagesIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='car-outline'/>
);

export const HarvestBatchesIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='shopping-cart-outline'/>
);

export const PlantGroupsIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='layers-outline'/>
);

export const PlantBatchesIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='brush-outline'/>
);

export const TagsIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='pricetags-outline'/>
);

export const ProductsIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='cube-outline'/>
);

export const LocationsIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='navigation-2-outline'/>
);

export const StrainsIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='bulb-outline'/>
);

export const MainMenuIcon = (style: ImageStyle): IconElement => (
  <Icon fill="#ffffff" {...style} name='menu-outline'/>
);

export const ArrowIosBackIcon = (style: ImageStyle): IconElement => (
  <Icon fill="#ffffff" {...style} name='arrow-ios-back'/>
);
